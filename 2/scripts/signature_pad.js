...
//            window.location.href = "http://" + doc + "/omHomePage.php?divPanel=OwnerHome&divMainMiddlePanel=CustHome&panel=UpdateCust&updateMess=CustomerUpdated&custId=" + custId;
//
//        } else {
//            document.getElementById("main_ajax_loading_div").style.visibility = "visible";
//        }
//    };
//      xmlhttp.open("POST", "include/php/omcdsnsv.php?canvasData=" + canvasData + "&custId=" + custId , true);
//   window.location.href = "http://"+ doc +"/include/php/omcdccdd.php?divPanel=OwnerHome&panel=UpdateCust" + "&custId=" + custId ;
//     xmlhttp.send();

//   alert("Click 'OK' and the page will be refreshed");
//   location.reload();
//   header("Location: http://" . $documentRoot . "/include/php/signature.php");
//}
...
var doc;
   ...
   save_image("include/php/omcdsnsv.php", poststr);
...
loadXMLDoc();
    ...
    xmlhttp.open("POST", "include/php/omcdsnup.php?custSign=" + custSign + "&custId=" + custId , true);
    xmlhttp.send();
}
...
loadXMLDoc();
    ...
    xmlhttp.open("POST", "include/php/omgsnchk.php?custSign=" + custSign + "&custId=" + custId + "&girviCustSign=" + girviCustSign + "&doc=" + doc + "&girviId=" + girviId , true);
    xmlhttp.send();
}
...
//            document.getElementById("main_ajax_loading_div").style.visibility = "hidden";
//           
//        window.location.href = "http://" + doc + "/omHomePage.php?divPanel=OwnerHome&divMainMiddlePanel=CustHome&panel=CustGirviInfo&girviImg=loadImg&custId=" + custId + "&custSign=" + custSign + "&girviCustSign=" + girviCustSign;
...
function saveGirviImageData(canvasData ,custId, doc, girviId) {
   ...
   save_girvi_image("include/php/omgvsnsv.php", poststr);
...
loadXMLDoc();
    xmlhttp.onreadystatechange = function() {
        if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
            ...
            alert('Signature Deleted Successfully');
            window.location.href = "http://" + doc + "/omHomePage.php?divPanel=OwnerHome&divMainMiddlePanel=CustHome&panel=CustGirviInfo&girviImg=loadImg&custId=" + custId + "&girviId=" + girviId + "&custSign=" + custSign;
         } else {
            document.getElementById("main_ajax_loading_div").style.visibility = "visible";
        }
    };
    xmlhttp.open("POST", "include/php/omgvsndl.php?girviCustSign=" + girviCustSign + "&custId=" + custId + "&custSign=" + custSign + "&girviId=" + girviId , true);
    xmlhttp.send();
}