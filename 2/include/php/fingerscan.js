...
window.fscan = {
    ...
    api_url: 'omccwcfl.php', // URL to upload script
    ...
    get_html: function(width, height, server_width, server_height) {
        ...
        if (this.ie) {
            ...
            html += '<embed id="webcam_movie" src="' + this.swf_url + '" loop="false" menu="false" quality="best" bgcolor="#ffffff" width="' + width +
                    '" height="' + height + '" name="webcam_movie" align="middle" allowScriptAccess="always" allowFullScreen="false" type="application/x-shockwave-flash" \n\
