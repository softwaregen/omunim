...
var Demo = function () {
    ...
    var handleTheme = function () {
        ...
        if ($('.sidebar-pos-option').attr("disabled") === false) {
            $('.sidebar-pos-option', panel).val(Omtheme.isRTL() ? 'right' : 'left');
        }
        ...
        var setColor = function (color) {
            var color_ = (Omtheme.isRTL() ? color + '-rtl' : color);
    ...
    var setThemeStyle = function(style) {
        ...
        file = (Omtheme.isRTL() ? file + '-rtl' : file);

        $('#style_components').attr("href", Omtheme.getGlobalCssPath() + file + ".css");
